  ...
  function (
    ...
    return declare([BaseWidget, WidgetsInTemplateMixin], {
      ...
      postCreate: function () {
        ...
        //geometry service for projection
      ...
      startup: function () {
        ...
        on(this.locate, 'click', lang.hitch(this, function (evt) {
          ...
          // If coordinate system selected is 4326
          if (this.coordSystemSelect.value == 4326) {
            ...
            // If coordinate system selected is 27039
          else {
            // If valid input
      ...
      //changing the drop down option for coordinate type based on coordinate system
      ...
      _dobuffer: function () {
        ...
        for (var i = 0; i < incidentLayer.length; i++) {
          if (incidentLayer[i].graphics != null) {
            if (incidentLayer[i].graphics.length != 0)
              params.geometries = [incidentLayer[i].graphics[0].geometry]
          }
        }
